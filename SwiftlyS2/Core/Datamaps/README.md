...
**用法示例:**
```csharp
nint targetAddress = 0x12345678;
nint hookAddress = 0x87654321;
DatamapFunctionHookManager.AddHook(targetAddress, hookAddress);
```
...
```csharp
nint hook;
bool found = DatamapFunctionHookManager.TryGetHook(0x12345678, out hook);
```
